...
async function generatePDF(quote: any, items: any[]): Promise<Buffer> {
  ...
  doc.fontSize(8).fillColor('#94A3B8')
    ...
    .text('(313) 468-3225 | selacabinets.com', 50, 792, { align: 'center', width: 495 })
...
If you have any questions or would like to proceed, please don't hesitate to contact us at (313) 468-3225 or reply to this email.
