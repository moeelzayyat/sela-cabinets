        ...
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-charcoal-600 md:text-xl">
              Choose the consultation type that works best for you. We&apos;ll help you understand options, next steps, and whether SELA is the right fit for your project.
            </p>
          </div>
        </div>
      </section>
          ...
          {!showEmbed ? (
            <div className="grid gap-6 lg:grid-cols-3">
              {appointmentTypes.map((type) => (
                ...
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-primary text-primary-foreground transition-colors group-hover:bg-[#184A47]">
