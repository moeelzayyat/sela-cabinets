...
export default function AnnArborPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  'In-home measurement in Ann Arbor',
      ...
      <CTASection 
        title="Ann Arbor Kitchen Cabinet Consultation"
        description="Book an Ann Arbor consultation. We'll bring samples, measure your space, and review cabinet options for your project."
        variant="wood"
      />
    </>
  )
