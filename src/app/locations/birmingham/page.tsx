...
export default function BirminghamPage() {
  return (
    <>
      ...
      <CTASection 
        title="Birmingham Kitchen Cabinet Consultation"
        description="Book a Birmingham consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
