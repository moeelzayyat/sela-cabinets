...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in Birmingham, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving Birmingham & Oakland County.',
...
export default function BirminghamPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-4xl font-bold md:text-5xl lg:text-6xl">
                Kitchen Cabinets in Birmingham
              </h1>
              <p className="mt-6 text-lg text-charcoal-300">
                Elegant kitchen cabinets for Birmingham homes. Quality craftsmanship, 
                professional installation, and service that matches the sophistication of your neighborhood.
              </p>
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">Birmingham Service</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for Birmingham Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your Birmingham kitchen project completely.',
              },
              {
                title: 'Premium Products',
                description: 'Cabinets with quality construction and beautiful finishes for discerning homeowners.',
              },
              {
                title: 'Local Expertise',
                description: 'Understanding of Birmingham and Oakland County home styles and expectations.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="Birmingham Kitchen Cabinet Quote"
        description="Book your free Birmingham consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
