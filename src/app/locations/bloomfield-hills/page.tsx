...
export default function BloomfieldHillsPage() {
  return (
    <>
      ...
      <CTASection 
        title="Bloomfield Hills Kitchen Cabinet Consultation"
        description="Book a Bloomfield Hills consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
