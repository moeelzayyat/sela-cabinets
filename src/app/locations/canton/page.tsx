...
export default function CantonPage() {
  return (
    <>
      ...
      <CTASection 
        title="Canton Kitchen Cabinet Consultation"
        description="Book a Canton consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
