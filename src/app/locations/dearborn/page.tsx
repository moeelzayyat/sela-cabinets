...
export default function DearbornPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  'In-home measurement in Dearborn',
                  '24+ cabinet styles ',
                  'Timeline confirmed after inspection',
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description: 'We come to your Dearborn home for precise measurements before your cabinet order is finalized.',
              },
              {
      ...
      <CTASection 
        title="Plan Your Dearborn Kitchen Project"
        description="Book an in-home consultation. We'll bring samples, measure your space, and review the best cabinet options for your home."
        variant="dark"
      />
    </>
  )
