...
export default function FarmingtonHillsPage() {
  return (
    <>
      ...
      <CTASection 
        title="Farmington Hills Kitchen Cabinet Consultation"
        description="Book a Farmington Hills consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
