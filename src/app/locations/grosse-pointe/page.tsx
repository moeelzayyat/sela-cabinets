...
export default function GrossePointePage() {
  return (
    <>
      ...
      <CTASection 
        title="Grosse Pointe Kitchen Cabinet Consultation"
        description="Book a Grosse Pointe consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
