...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in Grosse Pointe, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving Grosse Pointe & Detroit area.',
...
export default function GrossePointePage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-4xl font-bold md:text-5xl lg:text-6xl">
                Kitchen Cabinets in Grosse Pointe
              </h1>
              <p className="mt-6 text-lg text-charcoal-300">
                Elegant kitchen cabinets for Grosse Pointe homes. Historic charm meets 
                modern quality with professional installation on the Eastside.
              </p>
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">Grosse Pointe Service</h2>
              <ul className="mt-6 space-y-4">
                {[
                  'Serving all Grosse Pointe communities',
                  'Free in-home measurements',
                  'Eastside Detroit kitchen experts',
                  'Respect for historic homes',
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for Grosse Pointe Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your Grosse Pointe kitchen project with care.',
              },
              {
                title: 'Premium Products',
                description: 'Cabinets that complement the elegance of Grosse Pointe homes.',
              },
              {
                title: 'Historic Expertise',
                description: 'Understanding of Grosse Pointe architecture and renovation requirements.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="Grosse Pointe Kitchen Cabinet Quote"
        description="Book your free Grosse Pointe consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
