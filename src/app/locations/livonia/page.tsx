  ...
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  'In-home measurement in Livonia',
                  '24+ cabinet styles available',
                  'Installation timing confirmed after inspection',
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description: 'Precise measurements at your Livonia home before your cabinet order is finalized.',
              },
              {
                title: 'Professional Install',
                description: 'Clean, efficient installation planned after inspection, ordering, delivery, and site readiness are confirmed.',
              },
            ].map((service) => (
      ...
      <CTASection 
        ...
        description="Start a Livonia cabinet estimate with an in-home consultation and measured project review."
        variant="wood"
      />
    </>
  )
