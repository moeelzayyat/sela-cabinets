...
export default function NoviPage() {
  return (
    <>
      ...
      <CTASection 
        title="Novi Kitchen Cabinet Consultation"
        description="Book a Novi consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
