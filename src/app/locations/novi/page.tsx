...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in Novi, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving Novi & Oakland County.',
...
export default function NoviPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-4xl font-bold md:text-5xl lg:text-6xl">
                Kitchen Cabinets in Novi
              </h1>
              <p className="mt-6 text-lg text-charcoal-300">
                Modern kitchen cabinets for Novi homes. Quality craftsmanship, 
                professional installation, and service for this growing community.
              </p>
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">Novi Service</h2>
              <ul className="mt-6 space-y-4">
                {[
                  'Serving Novi & Northville',
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for Novi Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your Novi kitchen project completely.',
              },
              {
              ...
              },
              {
                ...
                description: 'Understanding of Novi and Oakland County homes.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="Novi Kitchen Cabinet Quote"
        description="Book your free Novi consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
