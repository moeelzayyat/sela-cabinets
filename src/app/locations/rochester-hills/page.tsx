...
export default function RochesterHillsPage() {
  return (
    <>
      ...
      <CTASection 
        title="Rochester Hills Kitchen Cabinet Consultation"
        description="Book a Rochester Hills consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
