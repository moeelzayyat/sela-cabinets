...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in Rochester Hills, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving Rochester Hills & Oakland County.',
...
export default function RochesterHillsPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-4xl font-bold md:text-5xl lg:text-6xl">
                Kitchen Cabinets in Rochester Hills
              </h1>
              <p className="mt-6 text-lg text-charcoal-300">
                Elegant kitchen cabinets for Rochester Hills homes. Quality craftsmanship, 
                professional installation, and service for this beautiful community.
              </p>
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">Rochester Hills Service</h2>
              <ul className="mt-6 space-y-4">
                {[
                  'Serving Rochester Hills & Rochester',
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for Rochester Hills Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your Rochester Hills kitchen project completely.',
              },
              {
              ...
              },
              {
                ...
                description: 'Understanding of Rochester Hills and Oakland County homes.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="Rochester Hills Kitchen Cabinet Quote"
        description="Book your free Rochester Hills consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
