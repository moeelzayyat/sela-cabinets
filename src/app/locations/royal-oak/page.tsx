...
export default function RoyalOakPage() {
  return (
    <>
      ...
      <CTASection 
        title="Royal Oak Kitchen Cabinet Consultation"
        description="Book a Royal Oak consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
