...
export default function ShelbyTownshipPage() {
  return (
    <>
      ...
      <CTASection 
        title="Shelby Township Kitchen Cabinet Consultation"
        description="Book a Shelby Township consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
