...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in Shelby Township, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving Shelby Township & Macomb County.',
...
export default function ShelbyTownshipPage() {
  return (
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-4xl font-bold md:text-5xl lg:text-6xl">
                Kitchen Cabinets in Shelby Township
              </h1>
              <p className="mt-6 text-lg text-charcoal-300">
                Quality kitchen cabinets for Shelby Township homes. Professional installation 
                and service for Macomb County families.
              </p>
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">Shelby Township Service</h2>
              <ul className="mt-6 space-y-4">
                {[
                  'Serving Shelby Township & Utica',
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for Shelby Township Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your Shelby Township kitchen project completely.',
              },
              {
              ...
              },
              {
                ...
                description: 'Understanding of Shelby Township and Macomb County homes.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="Shelby Township Kitchen Cabinet Quote"
        description="Book your free Shelby Township consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
