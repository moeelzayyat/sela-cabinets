...
export default function TroyPage() {
  return (
    <>
      ...
      <CTASection 
        title="Troy Kitchen Cabinet Consultation"
        description="Book a Troy consultation. We'll bring samples, measure your space, and review cabinet options for your project."
        variant="dark"
      />
    </>
  )
