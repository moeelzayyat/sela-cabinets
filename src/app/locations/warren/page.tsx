  ...
  return (
    <>
      ...
      <CTASection 
        ...
        description="Book a Warren consultation. We'll bring samples, measure your space, and review cabinet options for your project."
        variant="wood"
      />
    </>
  )
