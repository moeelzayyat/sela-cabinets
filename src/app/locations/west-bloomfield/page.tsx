...
export default function WestBloomfieldPage() {
  return (
    <>
      ...
      <CTASection 
        title="West Bloomfield Kitchen Cabinet Consultation"
        description="Book a West Bloomfield consultation. We'll bring samples, measure your space, and review cabinet options for your project."
      />
    </>
  )
}
