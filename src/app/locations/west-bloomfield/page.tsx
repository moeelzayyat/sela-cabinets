...
export const metadata: Metadata = {
  ...
  description: 'Kitchen cabinet installation in West Bloomfield, MI. Premium cabinets, professional measuring & installation. Free in-home estimates. Serving West Bloomfield & Oakland County.',
...
export default function WestBloomfieldPage() {
  return (
    <>
        ...
        <div className="container-wide">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-2xl bg-charcoal-800 p-8">
              <h2 className="font-display text-2xl font-bold">West Bloomfield Service</h2>
              <ul className="mt-6 space-y-4">
                {[
                  'Serving West Bloomfield & Orchard Lake',
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold text-charcoal-900">Cabinet Services for West Bloomfield Homes</h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {[
              {
                title: 'Full Service',
                description: 'From selection to installation, we handle your West Bloomfield kitchen project completely.',
              },
              {
              ...
              },
              {
                ...
                description: 'Understanding of West Bloomfield and Oakland County homes and styles.',
              },
            ].map((service) => (
      ...
      <CTASection 
        title="West Bloomfield Kitchen Cabinet Quote"
        description="Book your free West Bloomfield consultation. We'll bring samples and provide a detailed quote for your project."
      />
    </>
  )
}
