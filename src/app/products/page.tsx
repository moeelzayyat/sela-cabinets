        ...
        <div className="container-wide">
          <Tabs defaultValue="framed" className="w-full">
            <div className="-mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0">
              <TabsList className="h-auto min-w-max p-1">
                <TabsTrigger value="framed" className="px-4 py-3 text-sm sm:px-6 sm:text-base">
                  Framed Cabinets
                  <span className="ml-2 text-xs text-charcoal-500">(16 styles)</span>
                </TabsTrigger>
                <TabsTrigger value="frameless" className="px-4 py-3 text-sm sm:px-6 sm:text-base">
                  Frameless Cabinets
                  <span className="ml-2 text-xs text-charcoal-500">(8 styles)</span>
                </TabsTrigger>
                <TabsTrigger value="specs" className="px-4 py-3 text-sm sm:px-6 sm:text-base">
                  Specifications
                </TabsTrigger>
              </TabsList>
            </div>
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between">
                        ...
                        {style.isNew && (
                          <span className="rounded-full border border-wood-200 bg-wood-100 px-2 py-1 text-xs font-semibold text-wood-700">
                            NEW
                          </span>
                        )}
                      </div>
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <div className="rounded-2xl border border-charcoal-200 bg-white p-8">
                  ...
                  <ul className="mt-6 space-y-4 text-charcoal-600">
                    ...
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                      3/4 inch thick solid wood frame with MDF center
                    </li>
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                      3/4 inch thick cabinet-grade plywood shelving
                    </li>
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                    ...
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                      1/2 inch cabinet-grade plywood box, UV coated interior
                    </li>
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                ...
                <div className="rounded-2xl border border-charcoal-200 bg-white p-8">
                  ...
                  <ul className="mt-6 space-y-4 text-charcoal-600">
                    ...
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                      3/4 inch thick MDF flat door, melamine paper finish
                    </li>
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                      3/4 inch particle board box, melamine both sides
                    </li>
                    <li className="flex gap-3">
                      <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
