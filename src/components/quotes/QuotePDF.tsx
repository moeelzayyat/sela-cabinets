      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Thank you for choosing SELA Cabinets! • (313) 468-3225 • selacabinets.com
          </Text>
          <Text style={[styles.footerText, { marginTop: 4 }]}>
            Premium cabinet guidance, precise measurement, and professional installation
          </Text>
        </View>
      </Page>
    </Document>
