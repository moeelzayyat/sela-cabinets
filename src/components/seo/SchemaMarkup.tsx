export function LocalBusinessSchema() {
  const schema = {
    ...
    "description": "Premium kitchen cabinet supply and installation services in Detroit, Michigan. Professional in-home measurement, design guidance, and quality installation.",
    "url": "https://selacabinets.com",
    "telephone": "+1-313-468-3225",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Premium semi-custom kitchen cabinets with curated styles and finishes"
          }
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          "itemOffered": {
            ...
            "description": "In-home measurement service with cabinet order"
          }
        },
        {
          "@type": "Offer",
